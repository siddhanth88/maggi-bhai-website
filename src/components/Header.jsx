...
//           isScrolled ? "py-0 sm:py-0" : "py-0 sm:py-0"
//         }`}
//       >
...
//               isScrolled
//                 ? "bg-slate-900/80 backdrop-blur-2xl shadow-2xl border border-slate-700/50"
//                 : "bg-slate-900/60 backdrop-blur-xl shadow-lg border border-slate-700/30"
//             } rounded-full w-fit`}
//           >
//             {/* Ambient glow effect */}
//             <div
...
//               }`}
//             >
//               <div className="absolute inset-0 rounded-full bg-gradient-to-r from-orange-500/10 via-transparent to-orange-500/10 blur-xl" />
//             </div>
...
//                   />
//                   <div className="relative flex items-center justify-center w-8 h-8 transition-all duration-300 rounded-lg sm:w-9 sm:h-9 group-hover:rotate-12">
//                     {/* <Vote
...
//                 className="relative flex items-center justify-center w-8 h-8 transition-all duration-300 rounded-full lg:hidden group hover:bg-white/10"
//               >
//                 {isMobileMenuOpen ? (
//                   <X
...
//               }`}
//             >
//               <div className="px-3 pb-3 space-y-1.5 border-t sm:px-4 sm:pb-4 border-slate-700/50">
//                 {/* Navigation Links */}
...
//                     className="block px-3 py-2 text-xs font-semibold transition-all duration-300 rounded-xl text-slate-300 hover:text-white hover:bg-white/10"
...
//                     href="tel:+91XXXXXXXXXX"
//                     onClick={() => setIsMobileMenuOpen(false)}
//                     className="flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-semibold transition-all duration-300 rounded-xl text-slate-300 hover:text-white hover:bg-white/10"
//                   >
...
//                     }}
//                     className="relative flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-bold text-white transition-all duration-300 overflow-hidden rounded-xl group"
//                   >
...
export default function Header() {
  ...
  return (
    <>
      {/* Header */}
      <header
        className={`fixed top-0 left-0 right-0 lg:right-auto z-50 transition-all duration-500 ${
